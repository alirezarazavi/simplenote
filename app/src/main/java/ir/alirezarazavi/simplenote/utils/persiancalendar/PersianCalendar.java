 ...
 */
package ir.alirezarazavi.simplenote.utils.persiancalendar;
...
public class PersianCalendar extends GregorianCalendar {
	...
	public String getPersianDateAndTime() {
	...
	public String getPersianDigitDateAndTime() {
		return getPersianYear() + "-" + getPersianMonth() + "-" + getPersianDay() + "_" + get(HOUR_OF_DAY) + "-" + get(MINUTE);
	}
	...
	//}
	//
	//public String getPersianLongDateAndTimeWithoutSeconds() {
	//	return getPersianLongDate() + " ساعت " + get(HOUR_OF_DAY) + ":" + get(MINUTE);
	//}

	public String getPersianTime() {
		return " ساعت " + get(HOUR_OF_DAY) + ":" + get(MINUTE);
	}
